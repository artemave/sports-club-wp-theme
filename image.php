                    ...
                    <header class="entry-header">
                        ...
                        <div class="footer-infometa">
                            <?php
                                ...
                                printf( esc_html__( 'Published <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s">%4$s &times; %5$s</a> in <a href="%6$s" rel="gallery">%7$s</a>', 'sports-club-lite' ),
